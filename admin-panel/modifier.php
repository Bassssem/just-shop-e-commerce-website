...
?>
                          <tr>
                            ...
                            <td> <?php echo($date);?> </td>
                            <td> <?php 
echo('<a href="modif.php?num=0&&id='.$rows['id'].'"><u name="t" class="mdi mdi-grease-pencil"></u></a>');
?> </td>
                          </tr>
                          <?php } ?>
...
?>
                          <tr>
                            ...
                            <td> <?php echo($date);?> </td>
                            <td> <?php 
echo('<a href="modif.php?num=1&&id='.$rows['id'].'"><u name="t" class="mdi mdi-grease-pencil"></u></a>');
?> </td>
                          </tr>
                          <?php } ?>
